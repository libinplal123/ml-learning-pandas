...
data = pd.merge(movies,reviews,left_on="id",right_on="movie_id",how="inner") # use just, on, if both tables have common column
print(data.head())
...
print("language wise avg rating",data.groupby("language")["rating"].mean())